...
{
    /// <inheritdoc />
    public partial class MigrationAzureDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaNacimietno = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Salario = table.Column<double>(type: "float", nullable: true),
                    Comisiono = table.Column<double>(type: "float", nullable: true),
